...
if __name__ == "__main__":
    ...
    print(Config.get("WechatToken"))
    print(Config.get("APPID"))
    print(Config.get("EncodingAESKey"))
    print(Config.get("AdminID"))
    print(Config.get("Sukey"))
    print(Config.get("LlmMode"))
    print(Config.get("Tavilykey"))
    print(Config.get_nested('llm', 'LocalConfig', 'Model'))
    print(Config.get_nested('llm', 'LocalConfig', 'BaseUrl'))
    print(Config.get_nested('llm', 'OnlineConfig', 'APIKey'))
    print(Config.get_nested('llm', 'OnlineConfig', 'BaseUrl'))
    print(Config.get_nested('llm', 'OnlineConfig', 'Model'))
    print(Config.get_nested('llm', 'OnlineConfig', 'BaseUrl'))
    print(Config.get_nested('llm', 'OnlineConfig', 'Model'))